...
def gerar_relatorio_validacao(nome_arquivo, criterios, caminho_destino, epsg_detectado=None, tipo_geometria=None, contagem_feicoes=0):
    ...
    titulo = "Relatório de Validação da GeometriaValidada"
    ...
    y -= 20
    c.drawString(50, y, f"Tipo de GeometriaValidada: {tipo_geometria if tipo_geometria else 'Não identificado'}")
    y -= 20
    ...
    msg_final = "GeometriaValidada VALIDADA COM SUCESSO" if resultado else "GeometriaValidada INVÁLIDA - VERIFIQUE OS CRITÉRIOS ACIMA"
